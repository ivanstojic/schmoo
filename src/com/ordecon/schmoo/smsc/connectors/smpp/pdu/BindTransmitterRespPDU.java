...
public class BindTransmitterRespPDU extends BasicPDU {
	...
	out.writeHeader( 0x80000002, getStatus(), getSequence() );
	...
	return "PDU: bind_transmitter_resp (0x80000002) seq " + getSequence() + "\n"
