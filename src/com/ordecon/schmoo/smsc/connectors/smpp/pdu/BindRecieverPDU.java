...
public class BindRecieverPDU extends BasicPDU {
    public BindRecieverPDU () {
    }
	...
	out.writeHeader( 0x00000001, getStatus(), getSequence() );
	...
	if ( o instanceof BindRecieverPDU ) {
	    BindRecieverPDU p = (BindRecieverPDU) o;
	...
	return "PDU: bind_reciever (0x00000001) seq " + getSequence() + "\n"
