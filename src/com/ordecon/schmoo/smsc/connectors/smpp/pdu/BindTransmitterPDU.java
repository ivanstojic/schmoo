...
public class BindTransmitterPDU extends BasicPDU {
	...
	out.writeHeader( 0x00000002, getStatus(), getSequence() );
	...
	return "PDU: bind_transmitter (0x00000002) seq " + getSequence() + "\n"
