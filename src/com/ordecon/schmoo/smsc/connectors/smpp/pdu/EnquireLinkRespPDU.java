...
public class EnquireLinkRespPDU extends BasicPDU {
	...
	out.writeHeader( 0x80000015, getStatus(), getSequence() );
	...
	return "PDU: enquire_link_resp (0x80000015) seq " + getSequence() + "\n"
