...
public class BindTransceiverRespPDU extends BasicPDU {
	...
	out.writeHeader( 0x80000009, getStatus(), getSequence() );
	...
	return "PDU: bind_transceiver_resp (0x80000009) seq " + getSequence() + "\n"
